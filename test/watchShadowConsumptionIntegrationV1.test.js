...
test('22 no nearest-Swing guessing',function(){var c=sweep({sourceId:'EQH:1',sourceType:'EQH',side:'BSL'});var x=snap(c);assert.strictEqual(x.swing.canonicalSwingId,null);assert.deepStrictEqual(x.swing.canonicalSwingIds,[]);});
